...
void bind_bundle_adjustment(py::module& m) {
  ...
  py::class_<BundleAdjustmentSetup>(m, "BundleAdjustmentSetup")
      ...
      .def("set_constant_cam_positions", &BundleAdjustmentSetup::SetConstantCamPositions)
      .def("remove_constant_cam_positions", &BundleAdjustmentSetup::RemoveConstantCamPositions)
      .def("has_constant_cam_positions", &BundleAdjustmentSetup::HasConstantCamPositions)
