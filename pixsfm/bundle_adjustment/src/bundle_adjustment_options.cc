...
void BundleAdjustmentSetup::SetConstantCamPose(const colmap::image_t image_id) {
...
void BundleAdjustmentSetup::SetConstantCamPositions(const colmap::image_t image_id,
